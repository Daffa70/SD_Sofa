        ...
        if (matapelajaran.trim().isEmpty()){
            ...
            StringRequest request = new StringRequest(Request.Method.POST,
                    ...
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if (status == 0 ){
                                    Toast.makeText(TambahTugasActivity.this, message, Toast.LENGTH_SHORT).show();


                                }
                                else{
                                    Toast.makeText(TambahTugasActivity.this, "Tambar buku gagal " + message, Toast.LENGTH_SHORT).show();
                                }
                            }
                            catch (JSONException e){
                                Toast.makeText(TambahTugasActivity.this, "Error" + e.getMessage(), Toast.LENGTH_SHORT).show();
                            }
                        }
                ...
                public void onErrorResponse(VolleyError error) {
                    utilMessage.dismissProgressBar();
                    Toast.makeText(TambahTugasActivity.this, "Error "+error.getMessage(), Toast.LENGTH_SHORT).show();
                }
            }){
                @Override
